...
import 'package:legit/global variable/colors.dart';
...
class OnBoardingScreenState extends State<OnBoardingScreen> {
  final List<OnBoardingPage> _pages = [
    OnBoardingPage(
      ...
      description: 'Scan for registered  products',
    ),
    OnBoardingPage(
      imagePath: 'assets/images/onboarding_2.png',
      description: 'Report for fraudulent and smuggled products',
    ),
    OnBoardingPage(
      imagePath: 'assets/images/onboarding_3.png',
      description: 'Enjoy a safe and clean product comfortably!',
    ),
  ];
...
class OnBoardingPage {
  ...
  const OnBoardingPage({required this.imagePath, required this.description});
}
